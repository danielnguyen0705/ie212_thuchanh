...
spark-submit.cmd --master local[*] bai5.py 2>$null | Tee-Object -FilePath "output.txt"

Start-Process cmd.exe "/c stop-all.cmd" -WindowStyle Hidden
Write-Host "`n=== HOÀN TẤT! Kết quả đã lưu vào Bai5\output.txt ===" -ForegroundColor Green