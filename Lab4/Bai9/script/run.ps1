...
$INPUT = "D:\Daniel_Nguyen\UIT_HK6\IE212_CongNgheDuLieuLon\ThucHanh\Lab4\input"
Get-ChildItem "$INPUT\*.csv" | ForEach-Object { hdfs dfs -put -f $_.FullName /user/daniel/fecom_data/ }

Set-Location "$PSScriptRoot\.."

# Chạy và lưu kết quả sạch
spark-submit.cmd --master local[*] bai9.py 2>$null | Tee-Object -FilePath "output.txt"
