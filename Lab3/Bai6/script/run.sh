...
LOCAL_OUTPUT="/home/daniel/ThucHanhBigData/Lab3/Bai6/output"
HDFS_INPUT="/user/daniel/movie_data"
HDFS_OUTPUT="/user/daniel/movie_output_bai6"
...
hdfs dfs -put $LOCAL_INPUT/users.txt $HDFS_INPUT/
hdfs dfs -put $LOCAL_INPUT/occupation.txt $HDFS_INPUT/
...
spark-submit Lab3/Bai6/bai6.py
